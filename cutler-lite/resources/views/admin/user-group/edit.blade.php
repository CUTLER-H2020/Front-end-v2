                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            {!! Form::open(['route' => ['user-group.update', $userGroup->id]]) !!}
                            @csrf
                            <div class="form-horizontal">
                                <div class="form-body">
                                    <input type="hidden" name="parent_id" value="{{ $userGroup->parent_id }}" />
                                    <div class="form-group @if($errors->has('name')) has-error @endif">
                                       <label> {!! Form::label('name', trans('translation.general.user-group-edit.name'), ['class' => 'col-md-2 control-label'])  !!}</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                       <h4> {!! Form::label('name', trans('translation.general.user-group-edit.permissions'), ['class' => 'col-md-2'])  !!}</h4>
                                        <div class="col-md-12">
                                        <hr>
                                        <div class="row">
                                            @foreach($permissions as $groupName => $permissions)
                                            <div class="col-md-12">
                                                <label ><strong>"{{ $groupName }}" {{ trans('translation.general.user-group-edit.module-permissions') }}</strong></label>
                                                <div style="margin-top:20px;">
                                                    @foreach($permissions as $permission)
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                {!! Form::checkbox('permissions[]', $permission['code'], in_array($permission['code'], $userGroup->permissions), ['id' => $permission['code']])!!}
